import { handlerWorkSpace } from "@/actions/dashboardAction";
          ...
          <form action={handlerWorkSpace}>
            ...
            <div className="modal-action">
              <button
                type="submit"
                htmlFor="my_modal_6"
                className="btn bg-blue-600 rounded-lg text-white mr-3 h-12 px-5 flex items-center"
              >
                Create
              </button>
